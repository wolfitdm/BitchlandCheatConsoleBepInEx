...
* ow -> alias for the command openworld (works perfectly)
* openworld -> teleports you to the open world (works perfectly)
* ow2 -> alias for the command openworld2
* openworld2 -> use this command if openworld command no longer works
* ow3 -> alias for the openworld3 command
* openworld3 -> use this command if the other openworld commands no longer works
* ow4 -> alias for the openworld4 command
* openworld4 -> use this command if the other openworld commands no longer works
* ow5 -> alias for the openworld5 command
* openworld5 -> use this command if the other openworld commands no longer works
* mc -> alias for the maincity command
* maincity -> teleports you to the main city
* mc2 -> alias for the maincity2 command
* maincity2 -> use this command if the other maincity commands no longer works
* mc3 -> alias for the maincity3 command
* maincity3 -> use this command if the other maincity commands no longer works
* listalltypes -> list all components of a gameobject, the have you select with the copy command, and show his scripts (only for developer important)
* listalltypes2 -> list all components of a gameobject 2 , the have you selected with the copy command, and show his scripts (only for developer important)
* cursor -> you see the mouse cursor
* nocursor -> hides the mouse cursor
* nominingtools -> toggle you don't longer need mining tools and you can very fast mining
