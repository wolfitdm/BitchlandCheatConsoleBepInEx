...
* cleanskin -> cleans your skin
* nude -> set clothing condition to nude
* casual -> set clothing condition to casual
* sexy -> set clothing condition to sexy
* realnude -> set clothing condition to nude and all other states/clothing vibes to nude
* realcasual -> set clothing condition to nude and all other states/clothing vibes to casual
* realsexy -> set clothing condition to nude and all other states/clothing vibes to sexy
* heal  -> heal your player
* nohunger -> You don't longer hungry
* fullenergy -> full energy
* notoilet -> you dont need longer a toilet
* maxsexskills -> set all sex skills to level 300
* maxarmyskills -> set all army skills to level 300
* maxworkskills -> -> set all work skills to level 300
* maxallskills -> set all skills to level 300
* maxarousal -> set arousal heart to max
...
* maxrelationships -> sets all relationsships to maximum
* save -> saves the game on everytime in the normal slot
...
* lockold -> If you look at a door,drive or any lockable with the camera and enter this command in the console, then the door,drive or any lockable will be closed11
* unlockold ->  If you look at a door,drive or any lockable with the camera and enter this command in the console, then the door,drive or any lockable will be open
...
* forcekill -> kills the npc the you looked at, on everytime (forced), the person is also killed even if the game don't want that you kill this person
* die -> kills the npc the you looked at, on everytime (forced), the person is also killed even if the game don't want that you kill this person
* shit -> set the toilet to maximum
* sleep -> set the energy to 0
* infiniteammo -> toggle infiniteammo from your current weapon in your main hand
* npcshit -> set the npc the you looked at , his toilet to maximum
* npcsleep -> set the npc the you looked at, his energy to 0
...
* npcuse -> first look at a npc and use the command, then look at a item and use the command again, so that the npc can use the item
* sexnpcrandom ->  have sex with the npc the you looked at or chatted with, spawns random sex scene
* npcsexrandom ->  the selected npcs with the command npcsexselect have now sex, if you dont have select a npc, it select automatically the npc the you looked at, spawns random sex scene
* sexnpcrandomforce ->  the selected npcs with the command npcsexselect have now force sex, if you dont have select a npc, it select automatically the npc the you looked at, spawns random sex scene
* npcsexrandomforce ->  the selected npcs with the command npcsexselect have now forced sex, if you dont have select a npc, it select automatically the npc the you looked at, spawns random sex scene
* sexnpcrandomfollower -> you have sex with your followers, spawns random sex scene
* npcsexrandomfollower -> your followers have forced sex together, spawns random sex scene
* sexnpcrandomfollowerforce -> your have force sex with your followers, spawns random sex scene
* npcsexrandomfollowerforce -> your followers have forced sex together, spawns random sex scene
* usemultifollowerupgrade -> toggle config option UseMultiFollowerUpgrade
* usemultifollowerupgradeex -> toggle config option UseMultiFollowerUpgradeEx
* useharmonylistanimspatch -> toggle config option UseHarmonyListAnimsPatch
* followersexusing -> your follower on position 0 have sex with the npc the you looked at or chatted with
* sexusing -> your follower on position 0 have sex with the npc the you looked at or chatted with
* getpage -> shows your current page (is important if you have more as 10 followers)
* setpage -> set the page to 0 (is importantant if you have more as 10 followers)
...
* npcequip -> take your item or your weapon in hand, and give it to the npc the you looked at or chatted with; if the item is wearable, it will be put on the npc, otherwise the npc will get a backpack and the item will be added to it.
* npcequipfromhand -> take your item or your weapon in hand, and give it to the npc the you looked at or chatted with; if the item is wearable, it will be put on the npc, otherwise the npc will get a backpack and the item will be added to it.
* npcunequip -> It's the counterpart to the npcequip command: if the NPC has the item you're holding attached to their body, then the NPC will drop that item. If you have a weapon in your hand, the NPC will drop all of their weapons.
* npcunequipfromhand -> It's the counterpart to the npcequip command: if the NPC has the item you're holding attached to their body, then the NPC will drop that item. If you have a weapon in your hand, the NPC will drop all of their weapons.
* minrs -> all your relationships are really pissed on you, sure you want that?
* minrelationships -> all your relationships are really pissed on you, sure you want that?
* maxnpcrelationship -> maxed out the relationship from the npc the you looked at or chatted with
* maxnpcrs -> maxed out the relationship from the npc the you looked at or chatted with
* minnpcrelationship -> make the relationship from the npc the you looked at or chatted with really pissed on you
* minnpcrs -> make the relationship from the npc the you looked at or chatted with really pissed on you
* godmode -> toggle godmode, if godmode is on, you have everything, unlimited health, all weapons have unlimited ammo, all perks, fetishes, full gallery, all items
...
* maxsexskills level -> set all sex skills to level 
* maxarmyskills level -> set all army skills to level
* maxworkskills level -> set all work skills to level
* maxallskills level -> set all skills and trainings to level
* maxarousal level ->  set arousal to level
* npcmaxsexskills level -> set all sex skills from the npc the you looked at or chatted with to level
* npcmaxarmyskills level -> set all army skills from the npc the you looked at or chatted with to level
* npcmaxworkskills level -> set all work skills from the npc the you looked at or chatted with to level
* npcmaxallskills level -> set all skills and trainings from the npc the you looked at or chatted with to level
...
* removeitem name amount -> remove the item (amount) to your backpack, if you don't have a backpack, it gives you a backpack
...
* npcremoveitem name amount -> remove the npc the you are looked at this item (amount) to your backpack, if the npc don't have a backpack, it gives him a backpack
...
* setstate 0 false -> remove "Dirty -10 Sexy"
* setstate 1 true  -> add "Horny +10 Sexy"
* setstate 2 false -> remove "Very Dirty -20 Sexy"
* setstate 3 false -> Shitten -20 Sexy
* setstate 4 true -> add "Sleepy - ? speed"
* setstate 5 false -> remove "Needs toilet"
* getstate 6 -> Hungry
* setstate 7 true -> add "Pregnant"
* setstate 7 false -> remove "Pregnant"
* setstate 8 false -> remove "Bloody -10 Sexy"
* setstate 9 false -> remove "Clothing vibe Nude"
* setsate 10 false -> remove "Clothing vibe Casual"
* setstate 11 true -> add "Clothing vibe Sexy"
* setstate 12 false -> Cum Stains + 1 Sexy 
* setstate 13 false -> Cum Stains + 2 Sexy
* setstate 14 false -> Cum Stains + 3 Sexy
* setstate 15 false -> Cum Stains + 4 Sexy 
* setstate 16 false -> Cum Stains + 5 Sexy 
* setstate 17 false -> Body Writting + 1 Sexy 
* setstate 18 false -> Body Writting + 2 Sexy 
* setstate 19 false -> Body Writting + 3 Sexy 
* setstate 20 false -> Bruises - 10 Sexy 
* setstate 21 false -> Heavy Bruises - 20 Sexy 
* setstate 22 false -> Basic Makeup + 10 Sexy
* setstate 23 false -> Runny Makeup + 1 Sexy
* setstate 24 false -> Runny Makeup + 1 Sexy
* setstate 25 false -> Runny Makeup + 1 Sexy
* setstate 26 false -> Cum in mouth + 1 Sexy
* setstate 27 true -> Beard
* setstate 28 true -> Lipstick
* setstate 29 true -> Lipstick
* setstate 30 true -> Lipstick
* setstate 31 true -> Skin color lips
* setstate 32 true -> Freckets
* setstate 33 true -> Dirty Mouth
...
PLAN_Struct_RadioTower
PLAN_ConcreteFloor
PLAN_ConcreteWall
PLAN_WoodFloorFoundation
PLAN_ConcreteFloorFoundation
PLAN_Build_Stairs
PLAN_WoodFloor
PLAN_WoodWall
PLAN_ConcretePillar
PLAN_ConcretePillar2
PLAN_ConcreteDoor1
PLAN_ConcreteDoor2
PLAN_ConcreteWindow1
PLAN_ConcreteWindow2
PLAN_ConcreteWindow3
PLAN_WoodDoorway1
PLAN_WoodDoorway2
PLAN_WoodWindow1
PLAN_WoodWindow2
...
PLAN_WarStatue
PLAN_statue1
PLAN_WoodStairsFoundation
PLAN_Fence
PLAN_MetalBars
PLAN_MetalBarsDoorway
PLAN_WoodStairs
PLAN_WoodPillar1
PLAN_WoodPillar2
PLAN_Matress2
...
PLAN_Bed2
PLAN_Bed1
PLAN_ConcreteStairsFoundation
PLAN_Shack1
PLAN_Shack2
PLAN_WoodDoor
PLAN_GlassWindow
PatrolSpot
PLAN_ArmyManagementTable
PLAN_GlassLocker
PLAN_machine3
PLAN_SexMachine4
PLAN_TubeBike
PLAN_PreparatorStand
PLAN_DildoPole_1
PLAN_DildoPole_2
PLAN_DildoPole_3
PLAN_DildoPole_4
PLAN_DildoPole_5
PLAN_WoodPillar_stand
PLAN_WoodPillarBJ
PLAN_WoodPole1
PLAN_woodpole2
PLAN_woodpoleWide